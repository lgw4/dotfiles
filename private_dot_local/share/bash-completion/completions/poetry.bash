...
complete -o default -F _poetry_57beca8460d928bc_complete poetry
complete -o default -F _poetry_57beca8460d928bc_complete "${HOME}"/.local/pipx/venvs/poetry/bin/poetry
